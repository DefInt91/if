...
def print_template():
    ...
    try:
        if shortener(bitly_url) == "Invalid URL":
            ...
            def copy():
                print(str(status_variable.get()))
                print(str(severity_variable.get()))
                print(str(name.get()))
                print(str(", ".join(items)))
                print(str(tier_variable.get()))
                print(str(", ".join(op_items)))
                print(str(time_elapsed(int(sel_date1[0:4]), int(sel_date1[5:7]), int(sel_date1[8:10]), int(start_time1.get()), int(
                    start_time2.get()), int(sel_date2[0:4]), int(sel_date2[5:7]), int(sel_date2[8:10]), int(end_time1.get()), int(end_time2.get()))))
                print(str(sel_date1[0:4]))
                print(str(resolved_checker()))
                print(str("%, ".join(all_degradation)))
                print(str(symptoms_checker()))
                print(str(action_taken.get("1.0", "end-1c")))
                print(str(root_cause_variable.get()))
                print(str(comms_manager_variable.get()))
                print(str(crisis_man_checker()))
                print(str(escalated_by.get()))
                print(str())
                print(str(clik_id.get()))
                print(str(customer_ref.get()))
                print(str())
                print(str(shortener(bitly_url)))
